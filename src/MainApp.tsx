...
function MainApp() {
  ...
  // Warm the deferred chunks (panels + the common modals) once the app is idle (#356),
  // so the first Settings / ⌘N / file-panel open is instant.
  useEffect(() => prefetchDeferredChunks(true), []);
